...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roslisten' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tzeping/udacity/didi/proj/didiros/install/${idir}'.  Ask the maintainer 'tzeping <tzeping@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tzeping/udacity/didi/proj/didiros/install/lib;/opt/ros/indigo/lib)
