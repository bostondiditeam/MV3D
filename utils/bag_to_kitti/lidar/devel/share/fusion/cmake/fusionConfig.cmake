...
if("TRUE" STREQUAL "TRUE")
  set(fusion_SOURCE_PREFIX /ext2/didigithub/ros/src/detector/MV3D/utils/bag_to_kitti/lidar/src/fusion)
  set(fusion_DEVEL_PREFIX /ext2/didigithub/ros/src/detector/MV3D/utils/bag_to_kitti/lidar/devel)
  set(fusion_INSTALL_PREFIX "")
  set(fusion_PREFIX ${fusion_DEVEL_PREFIX})
else()
  set(fusion_SOURCE_PREFIX "")
  set(fusion_DEVEL_PREFIX "")
  set(fusion_INSTALL_PREFIX /ext2/didigithub/ros/src/detector/MV3D/utils/bag_to_kitti/lidar/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ext2/didigithub/ros/src/detector/MV3D/utils/bag_to_kitti/lidar/src/fusion/${idir}'.  Ask the maintainer 'mac <mac@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /ext2/didigithub/ros/src/detector/MV3D/utils/bag_to_kitti/lidar/devel/lib;/opt/ros/indigo/lib)
