...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fusion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/prerit/DiDi/MV3D/utils/bag_to_kitti/lidar/install/${idir}'.  Ask the maintainer 'mac <mac@todo.todo>' to fix it.")
    endif()
