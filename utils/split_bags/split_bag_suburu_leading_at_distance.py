...
bag_file = '/media/prerit/Data/didi_data/suburu/suburu_leading_at_distance/suburu12.bag'
bag = rosbag.Bag(bag_file)
bag_prefix = '/media/prerit/Data/didi_data/suburu/suburu_leading_at_distance_'
time_step = 34
