...
def draw_top_feature_map(top_dir, gt_boxes3d_dir, mark_dir, index):
    ...
    for file in sorted(glob.glob(top_dir + '/*.npy')):
        ...
        mlab.clf(fig)
        draw_didi_lidar(fig, feature_map_points, is_grid=1, is_axis=1)
        # if len(boxes3d)!=0:
...
if __name__ == '__main__':
    ...
    lidar_dir      =preprocessed_dir+ '/top'+dataset
    ...
    draw_top_feature_map(lidar_dir, gt_boxes3d_dir, mark_dir,11)
